...
fake_rc_html_parser = MagicMock()
sys.modules['spira_test_v4_0'] = fake_spira_test_v4_0
sys.modules['RCHtmlParser'] = fake_rc_html_parser
...
spira_rc_reportor = imp.load_source('RCSpiraTestReporter', os.path.join(spira_test_lib_base_dir, 'RCSpiraTestReporter.py'))

config = configparser.ConfigParser()
config.read(os.path.join(os.path.dirname(__file__),'config.ini'))

class RCSpiraTestReporter(unittest.TestCase):
	@patch('time.strptime')
	@patch('sys.argv')
	@patch('time.mktime')
	@patch.object(spira_rc_reportor,'print')
	def test_main_normal_case(self, mockPrint, mktime, sysArgv, strptime):
		fake_rc_html_parser.RCHtmlParser = MagicMock(return_value = fake_rc_html_parser)
		fake_rc_html_parser.parseRCUnitTestReport = MagicMock(return_value = json.loads(config['RCSpiraTestReporter']['examplereport']))
		...
		fake_testcase_folder = {"Name":"ts1","TestCaseId":38, "IndentLevel": "AACAAA"}
		fake_testcase1 = {"Name":"open","TestCaseId":39, "IndentLevel": "AACAAAAAA"}
		fake_testcase2 = {"Name":"type","TestCaseId":40, "IndentLevel": "AACAAAAAB"}
		fake_testcase3 = {"Name":"clickAndWait","TestCaseId":41, "IndentLevel": "AACAAAAAC"}

		def getTestcaseInFolder(id):
			if id == 34:
				return [fake_testcase1, fake_testcase2, fake_testcase3]
			elif id == 38:
				return [fake_testcase1, fake_testcase2, fake_testcase3]
			else:
				return None
		...
		fake_spira_test_v4_0.getTestCaseFolders = MagicMock(return_value = [fake_taas_folder, fake_testcase_folder])
		...
		spira_rc_reportor.main()
		self.assertEqual(fake_spira_test_v4_0.createNewTestRun.call_count, 3)
	...
	def test_main_no_fit_test_case_folder_case(self, mockPrint, mktime, sysArgv, strptime):
		...
		fake_taas_folder = {"TestCaseId": 34, "Name": "fakefolder", "IndentLevel": "AAC"}
		fake_testcase_folder = {"Name":"fts1","TestCaseId":38, "IndentLevel": "AACAAA"}
		fake_testcase1 = {"Name":"open","TestCaseId":39, "IndentLevel": "AACAAAAAA"}
		fake_testcase2 = {"Name":"type","TestCaseId":40, "IndentLevel": "AACAAAAAB"}
		fake_testcase3 = {"Name":"clickAndWait","TestCaseId":41, "IndentLevel": "AACAAAAAC"}
	...
	def test_main_no_fit_test_case_case(self, mockPrint, mktime, sysArgv, strptime):
		...
		fake_taas_folder = {"TestCaseId": 34, "Name": "fakefolder", "IndentLevel": "AAC"}
		fake_testcase_folder = {"Name":"ts1","TestCaseId":38, "IndentLevel": "AACAAA"}
		fake_testcase1 = {"Name":"fopen","TestCaseId":39, "IndentLevel": "AACAAAAAA"}
		fake_testcase2 = {"Name":"ftype","TestCaseId":40, "IndentLevel": "AACAAAAAB"}
		fake_testcase3 = {"Name":"clickAndWait","TestCaseId":41, "IndentLevel": "AACAAAAAC"}
		...
		fake_spira_test_v4_0.CreateNewRelease = MagicMock()
		spira_rc_reportor.main()
		self.assertEqual(fake_spira_test_v4_0.createNewTestRun.call_count, 1)
		self.assertEqual(fake_spira_test_v4_0.createTestCaseFolder.call_count, 0)
		self.assertEqual(fake_spira_test_v4_0.createTestCase.call_count, 0)
		self.assertEqual(fake_spira_test_v4_0.CreateNewRelease.call_count, 0)
		self.assertNotEqual(mockPrint.call_count, 0)
	...
	def test_main_autocreate_test_case_and_folder_case(self, mockPrint, mktime, sysArgv, strptime):
		...
		fake_testcase1 = {"Name":"fopen","TestCaseId":39, "IndentLevel": "AACAAAAAA"}
		fake_testcase2 = {"Name":"ftype","TestCaseId":40, "IndentLevel": "AACAAAAAB"}
		fake_testcase3 = {"Name":"fclickAndWait","TestCaseId":41, "IndentLevel": "AACAAAAAC"}
		...
		self.assertEqual(fake_spira_test_v4_0.createTestCase.call_count, 3)
		self.assertEqual(fake_spira_test_v4_0.CreateNewRelease.call_count, 0)
		self.assertNotEqual(mockPrint.call_count, 0)
	...
	def test_main_autocreate_release_case(self, mockPrint, mktime, sysArgv, strptime):
		...
		def getsysArgv(name):
			fakeargv = ['', 'fakereport', 'localhost', '80', '', 'TaaS', 'bbbb8264', '{3C958F7C-1F43-4D3B-BDA2-BFB21BAACE0D}', 'fakefolder', '', '', '0', 'AutoCreateTestCase', '3', 'newrelease', 'newversion']
			return fakeargv[name]
	...
	def test_main_regular_expression_change_test_case_case(self, mockPrint, mktime, sysArgv, strptime):
		...
		def getsysArgv(name):
			fakeargv = ['', 'fakereport', 'localhost', '80', '', 'TaaS', 'bbbb8264', '{3C958F7C-1F43-4D3B-BDA2-BFB21BAACE0D}', 'fakefolder', 'click', '', '0', 'AutoCreateTestCase', '0', '', '']
			return fakeargv[name]
		...
		fake_spira_test_v4_0.CreateNewRelease = MagicMock()
		spira_rc_reportor.main()
		self.assertEqual(fake_spira_test_v4_0.createNewTestRun.call_args[0][0]["RunnerTestName"], "AndWait")
		self.assertEqual(fake_spira_test_v4_0.createNewTestRun.call_count, 3)
		self.assertEqual(fake_spira_test_v4_0.createTestCaseFolder.call_count, 1)
		self.assertEqual(fake_spira_test_v4_0.createTestCase.call_count, 3)
		self.assertEqual(fake_spira_test_v4_0.CreateNewRelease.call_count, 0)
	...
	def test_main_suppress_level_1_case(self, mockPrint, mktime, sysArgv, strptime):
		...
		fake_taas_folder = {"TestCaseId": 34, "Name": "fakefolder", "IndentLevel": "AAC"}
		fake_testcase_folder = {"Name":"ts1","TestCaseId":38, "IndentLevel": "AACAAD"}
		fake_testcase1 = {"Name":"open","TestCaseId":39, "IndentLevel": "AACAAA"}
		fake_testcase2 = {"Name":"type","TestCaseId":40, "IndentLevel": "AACAAB"}
		fake_testcase3 = {"Name":"clickAndWait","TestCaseId":41, "IndentLevel": "AACAAC"}
