...
APP.get('/authority/:id', project.authority); //
...
APP.post('/shareProject',project.shareProject);  //add share project by sam
APP.post('/shareProjDestroy/:id',project.shareProjDestroy);  //add del share project by sam

APP.post('/editauthority/:id',project.editauthority);  //Status of front-end transfer to backend by Robert
...
APP.post('/getPermission', taskList.getPermission); // 2017.8.23 Tony
