...
/**
 * 
 * @param {*} cardInfo css attribute from on click card
...
/**
 * 
 * @param {*} URL specify card info API (reference to config.js)
 * @param {*} Type college, landscape, building
 * @param {*} id database index id
 */
...
/**
 * 
 * @param {*} departmentList department list info from DB
 */
