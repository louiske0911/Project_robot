...
_WebResourceData_WebResourceMIMEType_WebResourceTextEncodingName^WebResourceURL_WebResourceFrameNameO#<html><head></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">function Vector(x, y, z) {
    this.x = x;
    this.y = y;
    this.z = z;
...
setTimeout(updateCanvasDimensions, 30);</pre></body></html>_application/javascriptUUTF-8_Mhttp://s3.amazonaws.com/codecademy-content/courses/hour-of-code/js/bubbles.jsP    ( : P n } î#µ#Œ#‘$$                           $%